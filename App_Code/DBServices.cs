...
public class DBServices
{
    ...
    private String BuildInsertNewVisaCommand(Employee emp)
    {
        ...
        StringBuilder sb = new StringBuilder();
        // use a string builder to create the dynamic string
        sb.AppendFormat("Values('{0}','{1}' ,'{2}', '{3}', '{4}','{5}','{6}')",emp.Doctype_id,emp.Picture, DateTime.Now.ToString("yyyy-MM-dd"), emp.Ex_date.ToString("yyyy-MM-dd"),"True",emp.Employee_pass_id,emp.Doc_id);
